...
function searchForWords() {
    ...
    const searchTerms = {
        input1: ["تفريق بين الشاتين", "التفريق بين الشاتين", "التفريق", "تفريق"],
        input2: ["فعل أشياء خارقة", "فعل اشياء خارقه", "فعل شيء خارق", "فعل شي خارق", "غير واقعية", "غير واقعي", "اشياء", "شي"],
        input3: ["هروب من الأربي", "هروب أربي", "هروب اربي", "الهروب من الأربي", "الهروب من الاربي", "هروب", "الهروب", "اربي", "أربي", "الاربي", "الأربي"],
        input4: ["قتل شخص بدون سبب بالمركبة", "قتل شخص بدون سبب بالمركبه", "قتل شخص بدون سبب بالسيارة", "قتل شخص بدون سبب بالسياره", "قتل شخص بالمركبة", "قتل شخص بالمركبه", "بالمركبة", "بالمركبه", "بالسيارة", "بالسياره", "مركبة", "مركبه", "سياره", "سيارة"],
        input5: ["قتل شخص بدون سبب", "قتل بدون سبب", "قتل", "بدون سبب"],
        input6: ["إعدام الشخصية من قبل أدمن", "إعدام الشخصية من قبل ادمن", "اعدام الشخصية من قبل ادمن", "أعدام الشخصية من قبل أدمن", "اعدام الشخصية من قبل ادمن", "اعدام الشخصيه من قبل ادمن", "اعدام الشخصيه من قبل أدمن", "إعدام الشخصيه من قبل ادمن", "اعدام", "أعدام", "إعدام"],
    };
